...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:template match="v2:eCVI">
        <xsl:element namespace="http://www.usaha.org/xmlns/ecvi" name="eCVI">
            <xsl:apply-templates select="./@* | ./node()"/>
        </xsl:element>
    </xsl:template>
    ...
    <xsl:template
        ...
        <xsl:element namespace="http://www.usaha.org/xmlns/ecvi" name="{local-name()}" >
            <xsl:apply-templates select="./@* | ./node()"/>
        </xsl:element>
    </xsl:template>
    ...
    <xsl:template match="v2:NameParts">
        <xsl:element namespace="http://www.usaha.org/xmlns/ecvi"  name="Name">
    ...
    <xsl:template match="v2:Address">
        <xsl:element namespace="http://www.usaha.org/xmlns/ecvi" name="Address">
            <xsl:element namespace="http://www.usaha.org/xmlns/ecvi"  name="Line1">
                <xsl:choose>
            ...
            <xsl:if test="./v2:Line2">
                <xsl:element namespace="http://www.usaha.org/xmlns/ecvi"  name="Line2">
                    <xsl:value-of select="./v2:Line2"/>
                </xsl:element>
            </xsl:if>
            <xsl:element namespace="http://www.usaha.org/xmlns/ecvi"  name="Town">
                <xsl:choose>
            ...
            <xsl:if test="./v2:County">
                <xsl:element namespace="http://www.usaha.org/xmlns/ecvi"  name="County">
                    <xsl:value-of select="./v2:County"/>
                </xsl:element>
            </xsl:if>
            <xsl:element namespace="http://www.usaha.org/xmlns/ecvi"  name="State">
                <xsl:choose>
            ...
            <xsl:element namespace="http://www.usaha.org/xmlns/ecvi"  name="ZIP">
                <xsl:choose>
            ...
            <xsl:if test="./v2:Country">
                <xsl:element namespace="http://www.usaha.org/xmlns/ecvi"  name="Country">
                    <xsl:value-of select="./v2:Country"/>
                </xsl:element>
            </xsl:if>
            <xsl:if test="./v2:GeoPoint">
                <xsl:element namespace="http://www.usaha.org/xmlns/ecvi"  name="GeoPoint">
    ...
    <xsl:template name="agViewAddressBlock">
        ...
        <xsl:element namespace="http://www.usaha.org/xmlns/ecvi" name="Line1"><xsl:value-of select="$line1"/></xsl:element>
        <xsl:element namespace="http://www.usaha.org/xmlns/ecvi" name="Town"><xsl:value-of select="$town"/></xsl:element>
        <xsl:element namespace="http://www.usaha.org/xmlns/ecvi" name="State"><xsl:value-of select="$state"/></xsl:element>
        <xsl:element namespace="http://www.usaha.org/xmlns/ecvi" name="Zip"><xsl:value-of select="$zip"/></xsl:element>
    ...
    <xsl:template name="otherAddressBlock">
        ...
        <xsl:element namespace="http://www.usaha.org/xmlns/ecvi"  name="State">AA</xsl:element>
        <xsl:element namespace="http://www.usaha.org/xmlns/ecvi"  name="ZIP">
            <xsl:choose>
    ...
    <xsl:template match="v2:MovementPurpose">
        <xsl:element namespace="http://www.usaha.org/xmlns/ecvi"  name="MovementPurpose">
    ...
    <xsl:template match="v2:Field">
        <xsl:element namespace="http://www.usaha.org/xmlns/ecvi"  name="Laboratory">
    ...
    <xsl:template match="v2:Animal">
        <xsl:element namespace="http://www.usaha.org/xmlns/ecvi"  name="Animal">
            <xsl:if test="./@Age">
                <xsl:if test="./@Age">
            ...
            <xsl:for-each
                ...
                <xsl:element namespace="http://www.usaha.org/xmlns/ecvi"  name="AnimalTag">
            ...
            <xsl:for-each select="v2:Test">
                <xsl:element namespace="http://www.usaha.org/xmlns/ecvi"  name="Test">
                    ...
                    <xsl:for-each select="v2:Result">
                        <xsl:element namespace="http://www.usaha.org/xmlns/ecvi"  name="Result">
                            <xsl:attribute name="ResultName">
                                <xsl:value-of select="@ResultName"/>
                            </xsl:attribute>
                            <xsl:if test="./v2:ResultInteger">
                                <xsl:element namespace="http://www.usaha.org/xmlns/ecvi"  name="ResultInteger">
                                    <xsl:value-of select="./v2:ResultInteger"/>
                                </xsl:element>
                            </xsl:if>
                            <xsl:if test="./v2:ResultString">
                                <xsl:element namespace="http://www.usaha.org/xmlns/ecvi"  name="ResultString">
                                    <xsl:value-of select="./v2:ResultString"/>
                                </xsl:element>
                            </xsl:if>
                            <xsl:if test="./v2:ResultFloat">
                                <xsl:element namespace="http://www.usaha.org/xmlns/ecvi"  name="ResultFloat">
    ...
    <xsl:template match="v2:GroupLot">
        <xsl:element namespace="http://www.usaha.org/xmlns/ecvi"  name="GroupLot">
    ...
    <xsl:template match="v2:Attachment">
        ...
        <xsl:element namespace="http://www.usaha.org/xmlns/ecvi"  name="Attachment">
            ...
            <xsl:element namespace="http://www.usaha.org/xmlns/ecvi"  name="Payload">
