...
public interface SearchTextFieldListener{
   ...
   */
  public void newItem( SearchTextField stfSource );
  /**
   * Edit the currently selected item.
   * @param cbSource DBComboBox
   */
  public void editItem( SearchTextField stfSource );
  /**
   ...
   * @param cbSource DBComboBox
   */
  public void findItem( SearchTextField stfSource );

} // End interface SearchTextFieldListener
