...
public class TwoLineQuestionFrame extends JFrame {
	 ...
	 */
	public TwoLineQuestionFrame( String sTitle, String sQuestionOne, String sQuestionTwo ) {
		mTitle = sTitle;
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						TwoLineQuestionFrame.this.setVisible(false);
					}
				});
