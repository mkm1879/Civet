...
public interface DBSearchTextFieldListener{
  /**
   ...
   */
  public void newItem( DBSearchTextField stfSource );
  /**
   * Edit the currently selected item.
   * @param cbSource DBComboBox
   */
  public void editItem( DBSearchTextField stfSource );
  /**
   ...
   * @param cbSource DBComboBox
   */
  public void findItem( DBSearchTextField stfSource );
